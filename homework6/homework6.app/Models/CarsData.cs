namespace homework6.app.Models
{
    public static class CarsData
    {
        ...
        public static void PrintEverything(this List<Car> list)
        {
            foreach(Car item in list)
            {
                Console.WriteLine($"Model: {item.Model}, Horsepower: {item.HorsePower}, Origin: {item.Origin}, Cylinders: {item.Cylinders}, MilesPerGalon: {item.MilesPerGalon}, AccelerationTime: {item.AccelerationTime}");
            }
        }
